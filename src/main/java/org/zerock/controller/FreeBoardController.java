...
public class FreeBoardController {
	...
	@GetMapping("/list")
	public void list(@ModelAttribute("cri") FCriteria cri, @ModelAttribute("vo") FreeBoardVO vo,
			@ModelAttribute("User") MemberVO User, Model model) {
	...
	public String register(@ModelAttribute("vo") FreeBoardVO vo, Model model, RedirectAttributes rttr,
			HttpSession session) {
